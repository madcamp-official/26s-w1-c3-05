...
| 화면 | 기능 | 설명 |
|---|---|---|
| 로그인 화면 | 이메일/구글/카카오톡 로그인 | 이메일, 카카오톡, Google OAuth를 연동하여 간편하게 로그인할 수 있습니다. |
|  | 로그인 없이 둘러보기 | 로그인 없이 게스트로 서비스를 이용할 수 있습니다. |
| 고양이 지도 | 항공뷰 | 카이스트 전체 지도를 볼 수 있습니다. 사람들이 찍은 고양이 사진들이 위치와 함께 마커로 표시됩니다. 마커를 누르면 사진을 자세히 볼 수 있습니다. |
|  | 로드뷰 | 아바타 시점으로 카이스트 캠퍼스를 둘러볼 수 있습니다. 사람들이 촬영한 고양이들이 3D 모델로 나타납니다. |
|  | 촬영 | 고양이 사진을 촬영합니다 |
|  | 내 고양이 | 내가 찍은 고양이 사진들을 둘러봅니다 |
| 사이드바 | 고양이 도감 | 발견한 고양이 도감을 볼 수 있습니다 |
|  | 도움말 | 사용 설명서입니다 |
|  | 설정 | 닉네임과 프로필 사진을 변경할 수 있습니다. |
|  | 로그아웃 | 로그아웃 합니다 |
| 고양이 도감 | 발견한 고양이 둘러보기 | 어떤 고양이를 언제 어디서 만났는지, 몇 번 만났는지 등 기록을 돌아봅니다 |
